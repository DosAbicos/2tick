            ...
            <div className="minimal-card">
              ...
              <form onSubmit={handleSubmit} className="space-y-8" data-testid="create-contract-form">
                ...
                {loadingTemplate ? (
                  ...
                  <>
                {/* Party Roles Selection - ALWAYS SHOW */}
                <div className="p-6 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 border-2 border-purple-200 rounded-xl shadow-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">Роли сторон договора</h3>
                      <p className="text-sm text-gray-600">Выберите роли для обеих сторон</p>
                    </div>
                  </div>
                  <div className="bg-white rounded-lg p-4 border border-purple-100">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                      Выберите роли сторон *
                    </label>
                    <select
                      value={`${templateData.party_a_role}|${templateData.party_b_role}`}
                      onChange={(e) => {
                      ...
                      className="w-full px-4 py-3 bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all text-base font-medium text-gray-900"
                    >
                      {rolePairs.map((pair, idx) => (
                        <option key={idx} value={`${pair.a}|${pair.b}`}>
                          {pair.a} / {pair.b}
                        </option>
                      ))}
                    </select>
                    <div className="mt-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                      <p className="text-sm text-purple-800">
                        📝 Выбранные роли: <strong>{templateData.party_a_role}</strong> и <strong>{templateData.party_b_role}</strong>
                      </p>
                    </div>
                  </div>
                </div>
