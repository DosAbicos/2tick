        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-10">
          ...
          <div className="prose prose-gray max-w-none text-sm sm:text-base leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700">
                3.2. Оплата производится путём безналичного перечисления денежных средств на расчётный 
                счёт Исполнителя или через платёжные системы, доступные на сайте.
              </p>
              <p className="text-gray-700">
                3.3. Услуги считаются оплаченными с момента поступления денежных средств на счёт Исполнителя.
              </p>
            </section>
