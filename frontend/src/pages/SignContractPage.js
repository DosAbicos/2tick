          ...
          <CardContent className="space-y-6">
            ...
            {step === 1 && (
              ...
              >
                ...
                {/* Show unfilled placeholders */}
                {unfilledPlaceholders.length > 0 && (
                  <div className="mb-6 p-6 bg-gradient-to-br from-blue-50 via-purple-50/30 to-pink-50/30 border-2 border-blue-200 rounded-xl">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white">
                        ✏️
                      </div>
                      <div>
                        <h3 className="font-semibold text-slate-900">Заполните ваши данные</h3>
                        <p className="text-sm text-slate-600">Эти поля необходимо заполнить перед подписанием</p>
                      </div>
                    </div>
