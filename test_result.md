...
user_problem_statement: "Выполнение 4 новых задач: 1) Кнопка скачать договор должна быть после того как админ нажмет на просмотреть договор и договор должен скачиваться, 2) UI State Persistence - сохранение состояния открытых модальных окон и вкладок в админ-панели после обновления страницы, 3) Исправление переполнения (overflow) таблицы договоров пользователя в админ-панели, 4) Ускорение доставки email после одобрения договора."
