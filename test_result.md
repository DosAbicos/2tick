...
agent_communication:
  ...
  - agent: "main"
    message: "КРИТИЧЕСКОЕ ТЕСТИРОВАНИЕ Header: 1) На мобильной версии (< 640px) для неавторизованных должна быть ОДНА кнопка 'Войти', 2) На desktop для неавторизованных две кнопки 'Вход' и 'Регистрация', 3) Для авторизованных пользователей (админ) должны отображаться иконки User (профиль) и LogOut (выход), 4) Все иконки должны быть видны из lucide-react"